...
CREATE TABLE "ganxu"."order" (
  ...
  "province" varchar(60) COLLATE "pg_catalog"."default" NOT NULL,
  "city" varchar(60) COLLATE "pg_catalog"."default" NOT NULL,
  "district" varchar(60) COLLATE "pg_catalog"."default" NOT NULL,
...
CREATE TABLE "ganxu"."warehouse" (
  ...
  "district" varchar(60) COLLATE "pg_catalog"."default",
