...
-- ----------------------------
DROP TABLE IF EXISTS "ganxu"."user_authority";
CREATE TABLE "ganxu"."user_authority" (
...
;
COMMENT ON COLUMN "ganxu"."user_authority"."id" IS '用户信息表主键';
COMMENT ON COLUMN "ganxu"."user_authority"."role" IS '角色标识';
COMMENT ON COLUMN "ganxu"."user_authority"."perm" IS '权限标识';
COMMENT ON COLUMN "ganxu"."user_authority"."perm_code" IS '权限编码';
COMMENT ON COLUMN "ganxu"."user_authority"."create_time" IS '创建时间';
COMMENT ON COLUMN "ganxu"."user_authority"."update_time" IS '更新时间';
COMMENT ON TABLE "ganxu"."user_authority" IS '用户权限表';

-- ----------------------------
-- Uniques structure for table user_authority
-- ----------------------------
ALTER TABLE "ganxu"."user_authority" ADD CONSTRAINT "c_role_perm" UNIQUE ("role", "perm");
COMMENT ON CONSTRAINT "c_role_perm" ON "ganxu"."user_authority" IS '角色权限唯一键';

-- ----------------------------
-- Primary Key structure for table user_authority
-- ----------------------------
ALTER TABLE "ganxu"."user_authority" ADD CONSTRAINT "user_info_copy1_pkey" PRIMARY KEY ("id");
...
-- ----------------------------
ALTER TABLE "ganxu"."user_role" ADD CONSTRAINT "user_authority_copy1_pkey" PRIMARY KEY ("id");
